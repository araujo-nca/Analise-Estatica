...
% P_calc(:,:,i) = V_calc(:,:,i) .* P_calc(:,:,i); 
% Q_calc(:,:,i) = V_calc(:,:,i) .* Q_calc(:,:,i); 
...
%     delta_thetaV(:,:,i) = pinv(Jacob_bn(:,:,i)) * delta_PQ(:,:,i);
%     delta_thetaV(:,:,i) = bicgstab(Jacob_bn(:,:,i), delta_PQ(:,:,i), 1e-5, 150);
%     delta_thetaV(:,:,i) = bicg(Jacob_bn(:,:,i), delta_PQ(:,:,i), 1e-5, 150);
%     delta_thetaV(:,:,i) = gmres(Jacob_bn(:,:,i), delta_PQ(:,:,i), 30, 1e-5, 150);
%     delta_thetaV(:,:,i) = linsolve(Jacob_bn(:,:,i), delta_PQ(:,:,i));
